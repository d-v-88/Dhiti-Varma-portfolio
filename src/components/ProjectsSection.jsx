...
const projects = [
...

    {
        ...
        tags: ["React.js", "TailwindCSS", "MongoDB", "Node.js", "Express.js", "JWT "],
...

    {
        ...
        description: "A pixel-perfect frontend clone of Nike’s homepage, designed for practice and visual accuracy. The layout is fully responsive, showcasing a clean product-focused UI, sleek hover effects, and modern typography. Built using only HTML and CSS to sharpen frontend layout and styling skills.",
...

    {
        ...
        description: "A fully responsive clone of the Myntra homepage, built to practice real-world e-commerce layouts and responsive design. It includes category sections, a promotional banner, and navigation components — all styled to closely match Myntra's sleek and fashion-focused interface. This project helped strengthen my layout, media queries, and CSS design skills.",
    ...
    return <section id="projects" className="py-24 px-4 relative">
        <div className="container mx-auto max-w-5xl">
            ...
            <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                Here are somne of my recent projects. Each project was carefully crafted with attention to detail, performance, and user experience.
            </p>
            ...
            <div className="text-center mt-12">
                <a href="https://github.com/d-v-88" className="cosmic-button w-fit flex items-center mx-auto gap-2" target="_blank">
